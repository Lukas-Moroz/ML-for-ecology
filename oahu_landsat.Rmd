...
NDVI_df <- df %>%
  mutate(NDVI = (Near_Infrared - Red) / (Near_Infrared + Red))
...
#kmeans
set.seed(123)
km_result <- kmeans(NDVI_df [, c("x","y","Coastal_Aerosol", "Blue", "Green", "Red", "Near_Infrared", "Shortwave_Infrared_1", "Shortwave_Infrared_2", "NDVI")], 25, iter.max = 10)
